...
export type AnyRoutes = Record<string, Route<any, any, any, boolean>>;
...
export type ParamOptions<Value, DefaultValue, O, Source = never> = {
  stringify?(value: NoInfer<Value>): string;
  parse?(value: string, source: Source): Value;
  optional?: O;
  defaultValue?: DefaultValue | ((source: Source) => DefaultValue);
  fallbackValue?:
    | ((
